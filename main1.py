...
PARTICLE_MIN_SCALE = 0.012
PARTICLE_MAX_SCALE = 0.1
PARTICLE_MIN_X = -30
PARTICLE_MAX_X = 30
PARTICLE_VELOCITY_X = 0
PARTICLE_VELOCITY_Y = 3.6
PARTICLE_MIN_AX = -0.05
PARTICLE_MAX_AX = 0.05
PARTICLE_MIN_AY = -0.1
PARTICLE_MAX_AY = 0.1
PARTICLE_MIN_DECAY = 0.0005
PARTICLE_MAX_DECAY = 0.005
...
class Particle(arcade.Sprite):
    def __init__(self, asset, scale, x, y, dx, dy, ax, ay, decay):
        ...
        self.particle_colors = [
            (open_color.blue_3, 1)
            ,(open_color.yellow_1, 3)
            ,(open_color.yellow_2, 2)
            ,(open_color.orange_3, 7)
            ,(open_color.orange_4, 8)
            ,(open_color.orange_6, 12)
            ,(open_color.orange_7, 8)
...
class Window(arcade.Window):
    ...
    def update(self, delta_time):
        ...
        if self.mouse_down:
            ...
            particle = Particle('dirt_03',scale,x,y,dx,dy,ax,ay,decay)
